 ...
 *  // }
    ...
    var Result = tui.util.defineClass(/** @lends Result.prototype */{
        ...
        _attachEvent: function() {
            ...
            $(this.options.documentElement).on('click', $.proxy(function() {
                this.hideResultList();
            }, this));
        },
