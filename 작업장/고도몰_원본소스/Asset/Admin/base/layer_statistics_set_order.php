<form id="frmSet" name="frmSet" action="" method="post">
<input type="hidden" name="mode" value="setOrder" />
	<div class="page-header js-affix">
		<h3>매출통계설정 <small></small></h3>
	</div>
	...
	<div style="padding:8px 5px 8px 0;">
		...
		<div style="margin-top:5px;"><label><input type="checkbox" name="graphFl" value="y" <?php echo gd_isset($checked['graphFl']['y']);?>/>항상 매출그래프 보기(1주일)</label></div>
