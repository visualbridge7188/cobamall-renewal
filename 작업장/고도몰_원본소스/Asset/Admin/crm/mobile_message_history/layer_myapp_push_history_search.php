<section class="ncua-card__body">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="ncua-flex-gap js-push-status">
                                <label class="ncua-checkbox-field ncua-checkbox-field--xs has-text">
                                    <span class="ncua-checkbox-input ncua-checkbox-input--xs ncua-checkbox-field__input">
                                        <input type="checkbox" value="all" checked />
                                    </span>
    ...
    <div id="layerMyappPushHistoryResult"></div>
</section>
...
<script>
    ...
    function initializeEvents() {
        ...
        form.addEventListener('submit', async (e) => {
            ...
            if (!formData.has('scheduleTypes[]') || !formData.has('sendStatuses[]')) {
        ...
        ['.js-schedule-type', '.js-push-status'].forEach(selector => new CheckboxGroup(selector));
    }
    ...
    function loadContents(formData, isSearch = false) {
        ...
        $.ajax({
            url: './mobile_message_history/layer_myapp_push_history_result.php',
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
            success: function (data) {
                $('#layerMyappPushHistoryResult').html(data);
            },
            error: function () {
