...
<div class="modal-dialog__content layer-load-template js-sms-template-section">
    <ul>
                        ...
                        <div class="ncua-gap-4">
                            <div class="ncua-select ncua-select--xs">
                                <div class="ncua-select__content">
                                    <select class="ncua-select__tag" id="searchCategory" name="smsType">
...
<script type="text/javascript">
    ...
    async function searchTemplates(formData = null) {
        try {
            ...
            const response = await fetch(`./mobile_send/layer_mobile_send_sms_template_result.php?${params}`, {
                method: 'GET',
