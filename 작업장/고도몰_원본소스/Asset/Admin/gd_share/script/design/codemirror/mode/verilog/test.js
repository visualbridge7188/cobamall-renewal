...
(function() {
  ...
  MT("export_function_one-line_does_not_indent",
     "[keyword export] [string \"DPI-C\"] [keyword function] [variable helloFromSV];",
     ""
  );

  MT("export_task_one-line_does_not_indent",
  ...
  MT("import_function_one-line_does_not_indent",
    "[keyword import] [string \"DPI-C\"] [keyword function] [variable helloFromC];",
    ""
  );

  MT("import_task_one-line_does_not_indent",
