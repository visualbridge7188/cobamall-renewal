(function ($) {
	$.extend($.tree.plugins, {
		"contextmenu" : {
			...
			show : function(obj, t) {
				...
				// 20100914 sunny
				if (typeof opts.show_after !== "undefined" && typeof opts.show_after == "function") {
					opts.show_after.call(null, $.tree.plugins.contextmenu.data.a, t);
				}
			},
			hide : function () {
	...
	$(function () {
		...
		$(document).bind("mousedown", function(event) { if($(event.target).parents("#jstree-contextmenu").length == 0) $.tree.plugins.contextmenu.hide(); });
	});
})(jQuery);
