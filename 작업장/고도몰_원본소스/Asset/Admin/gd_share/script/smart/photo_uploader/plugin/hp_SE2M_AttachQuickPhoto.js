...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({
	...
	$ON_ATTACHPHOTO_OPEN_WINDOW : function(){
		...
		this.htPopupOption.sProperties = "left=0,top=0,width=403,height=480,scrollbars=yes,location=no,status=0,resizable=no";
	...
	makePopupURL : function(){
		var sPopupUrl = "/share/photo_uploader.php?editorUrl="+encodeURIComponent(parent.location.href);
		return sPopupUrl;
	},
	...
	$ON_SET_PHOTO : function(aPhotoData){
		...
		try{
			...
			for(var i = 0; i <aPhotoData.length; i++){
				...
				parent.addUploadImages(htData.sFileURL);
	...
	_getPhotoTag : function(htPhotoInfo){
		...
		var sTag = '<img src="{=sOriginalImageURL}" title="{=sName}" class="js-smart-img">';
