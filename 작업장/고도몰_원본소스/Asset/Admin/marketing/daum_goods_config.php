<div class="page-header js-affix">
    ...
    <div class="btn-group">
        <input type="button" value="노출상품 현황 확인" class="btn btn-white js-layer-daum-stats"/>
    ...
    <div class="search-detail-box">
        ...
        <table class="table table-cols">
            ...
            <tr>
                <th>쇼핑하우 노출여부</th>
                <td>
                    <label class="radio-inline"><input type="radio" name="daumFl" value="" <?=gd_isset($checked['daumFl']['']); ?> />전체</label>
                    <label class="radio-inline"><input type="radio" name="daumFl" value="y" <?=gd_isset($checked['daumFl']['y']); ?> />노출함</label>
                    <label class="radio-inline"><input type="radio" name="daumFl" value="n" <?=gd_isset($checked['daumFl']['n']); ?> />노출안함</label>
                </td>
                <th>연동대상</th>
                <td>
...
<form id="frmBatchDaum" name="frmBatchDaum" action="../goods/goods_ps.php"    target="ifrmProcess" method="post">
    <input type="hidden" name="mode" value="batch_daum_config" />
    ...
    <div class="table-responsive">
        <table class="table table-rows table-fixed">
            ...
            <tr>
                ...
                <th class="width-xs center" rowspan="2">쇼핑하우<br/>노출여부</th>
            ...
            if (gd_isset($data) && gd_count($data) > 0 ) {
                ...
                foreach ($data as $key => $val) {
                    ...
                    <tr>
                        ...
                        <td class="center"><?=$arrGoodsDisplay[$val['daumFl']]; ?></td>
    ...
    <div>
        <table class="table table-cols" id="setDaumConfig">
            <colgroup>
                <col class="width-md" />
                <col />
            </colgroup>
            <tr>
                <th class="center">쇼핑하우 노출설정</th>
                <td>
                    <label class="radio-inline"><input type="radio" name="daumFl" value="y" checked="checked" />노출함</label>
                    <label class="radio-inline"><input type="radio" name="daumFl" value="n" />노출안함</label>
                </td>
            </tr>
        </table>
    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $(".js-layer-daum-stats").click(function(e){
            layer_add_info('daum_stats');
        });
        $( "#batchSubmit" ).click(function() {
            ...
            msg += '카카오 쇼핑하우 노출 상태를 '+$('#setDaumConfig input[name="daumFl"]:checked').closest('label').text()+ '으로 ';
