    ...
    <div class="table-action-dropdown">
        <div class="table-action mgt0 mgb0">
            <div class="pull-left form-inline">
                ...
                <button type="button" class="btn btn-white js-save-invoice" />송장번호 저장</button>
                <?php if ($search['view'] != 'orderGoods') { ?>
                <button type="button" class="btn btn-black js-packet-lock" />묶음배송처리</button>
                <button type="button" class="btn btn-black js-packet-unlock" />묶음배송해제</button>
                <?php } ?>
            </div>
