    ...
    <div class="table-action-dropdown">
        <div class="table-action mgt0 mgb0">
            <div class="pull-left form-inline">
                ...
                <button type="button" class="btn btn-white js-user-accept" data-status-mode="back" />승인처리</button>
                <button type="button" class="btn btn-white js-user-reject" data-status-mode="back" />거절처리</button>
            </div>
