...
<table class="table table-cols">
    ...
    <tr>
        <th>PG사 모듈 버전</th>
        <td>AGSPay V4.1 웹표준 결제창 (V 4.1.3 - 20130403) / AGSMobile V2 결제창 (V 2 - 20150818)</td>
    </tr>
    <tr>
        <th>결제수단 설정</th>
        <td>
            ...
            <div class="notice-info notice-danger">모바일 결제창(AGSMobile V2 결제창)은 계좌이체를 지원하지 않습니다.</div>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <th><?php echo $pgNm;?> 휴대폰 결제 SUB_CPID</th>
        <td>
            <?php if ($data['pgAutoSetting'] === 'y') { ?>
...
?>
    ...
    <tr id="noInterestToggle">
        <th>무이자 할부 기간 설정</th>
        <td>
            <input type="button" onclick="noInterest_peroid_conf('<?php echo $data['pgCode'];?>');" value="기간 설정" class="btn btn-info btn-xs" />
...
<?php
    ...
    foreach ($arrPeroid as $key => $val) {
        ...
        echo '<div id="noInterest_Peroid_'.$divId.'">'.chr(10);
...
?>
    ...
    <tr>
        ...
        <td>
            <a href="https://www.allthegate.com/login/r_login.jsp" target="_blank" class="btn btn-gray btn-sm"><?php echo $pgNm;?> 상점 관리자모드 바로가기</a>
            <a href="http://www.allthegate.com/" target="_blank" class="btn btn-gray btn-sm"><?php echo $pgNm;?> 사이트 바로가기</a>
        </td>
    </tr>
</table>
...
<table class="table table-cols">
    ...
    <tr>
        <th>PG사 모듈 버전</th>
        <td>AGSPay V4.1 웹표준 결제창 (V 4.1.3 - 20130403) / AGSPay Escrow (20130201)</td>
    </tr>
    <tr>
        <th>사용상태</th>
        <td>
...
<table class="table table-cols">
    ...
    <tr>
        <th>PG사 모듈 버전</th>
        <td>AGSCash V1.0  (V 1.0 - 20110411)</td>
    </tr>
    <tr>
        <th>사용 설정</th>
        <td>
