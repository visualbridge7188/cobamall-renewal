...
?>
    ...
    <tr>
        ...
        <td>
            ...
            <div class="notice-danger">
                <div>NHN KCP와 계약한 과세정보로 꼭! 설정해주세요.</div>
                <div>- 설정한 과세정보로 결제 요청 되므로 계약하지 않은 과세정보를 설정하는 경우 부분취소가 어려울 수 있습니다.</div>
            </div>
    ...
    <tr>
        ...
        <td>
            <a href="https://partner.kcp.co.kr/auth/login" target="_blank" class="btn btn-gray btn-sm"><?php echo $pgNm;?> 상점 관리자모드 바로가기</a>
