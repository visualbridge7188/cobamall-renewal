...
<div>
    ...
    <div>
        <table class="table table-cols no-title-line">
            ...
            <tr>
                <th>카카오 쇼핑하우<br/>상품노출 현황</th>
                <td><span class="js-stats-daum"><?=number_format($statsData['daum'])?></span>개의 상품을 카카오 쇼핑하우에 노출 중입니다. (총 상품 수 : <span class="js-stats-total"><?=number_format($statsData['total'])?></span>개)</td>
...
<div>
    <p class="notice-info">카카오 쇼핑하우에 노출되는 상품수를 카테고리별로 확인하실 수 있습니다.</p>
