...
<script type="text/html" id="downloadReason">
    ...
    <div class="well">
        ...
        <div class="notice-info">엑셀 다운로드 사유는 설정 > 기본정책 > 코드 관리에서 추가 가능합니다.</div>
    </div>
</script>
        ...
        <tr>
            ...
            <td colspan="3">
                <div class="form-inline">
                    ...
                    <?php if($menu =='goods' && ($location =='goods_list' || $location=='goods_list_delete' || $location =='regular_goods_list')) {?>
