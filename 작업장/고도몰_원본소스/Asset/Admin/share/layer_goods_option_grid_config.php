...
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		$(".js-save").click(function(e){
			$("input[name='mode']").val('save_goods_option_admin_grid_list');
			$("#goodsGridOptionForm").submit();
		});
		...
		$(".js-add").click(function(e){
			...
			$(".js-field-default tr.default_select").each(function () {
				...
				if(check == true){
					...
					newClone.append("<input type='hidden' name='goodsOptionGridList[]' value='"+$(this).data("field-key")+"' />");
		...
		$(".js-goods-grid-sort").change(function(){
			$("input[name='mode']").val('get_grid_option_list_sort');
			...
			if(data){
				...
				if(goods_grid_data_select){
					...
					$.each(goods_grid_data_select, function (key, val) {
						...
						contentsHtml+= val;
						contentsHtml+= "<input type='hidden' name='goodsOptionGridList[]' value='"+key+"' />";
						contentsHtml+= "</td></tr>";
					});
