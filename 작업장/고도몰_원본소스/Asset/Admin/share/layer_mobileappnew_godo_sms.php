...
<script type="text/javascript">
    ...
    $(document).ready(function () {
                    ...
                    if (result.trim() == 'Y') {
                        BootstrapDialog.show({
                            ...
                            onhidden: function(dialog) {
                                location.replace('/mobileappnew/mobileapp_sms_accept_process.php?device_uid=' + $('#device_uid').val());
                            }
                        });
                    } else {
                        alert(result);
        ...
        $('.js-layer-close').bind('click', function(e){
            stopCountDown();
            window.location.replace('https://mobileapp.godo.co.kr/new2/app/login.php');
        });
    });
