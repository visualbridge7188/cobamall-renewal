        ...
        var container = document.getElementById('chart-area'),
            data = {
                ...
                series: [
                    ...
                    {
                        name: '10대',
                        data: [<?= gd_implode(',', $memberChart['Member10']); ?>]
                    },
                    {
                        name: '20대',
                        data: [<?= gd_implode(',', $memberChart['Member20']); ?>]
                    },
                    {
                        name: '30대',
                        data: [<?= gd_implode(',', $memberChart['Member30']); ?>]
                    },
                    {
                        name: '40대',
                        data: [<?= gd_implode(',', $memberChart['Member40']); ?>]
                    },
                    {
                        name: '50대',
                        data: [<?= gd_implode(',', $memberChart['Member50']); ?>]
                    },
                    {
                        name: '60대',
                        data: [<?= gd_implode(',', $memberChart['Member60']); ?>]
                    },
                    {
                        name: '70대',
                        data: [<?= gd_implode(',', $memberChart['Member70']); ?>]
                    },
                    {
                        name: '연령 미확인 회원수',
