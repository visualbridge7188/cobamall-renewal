...
<div class="table-title gd-help-manual">예치금 검색</div>
...
<div class="table-action form-inline mgb0">
        ...
        var container = document.getElementById('chart-area'),
            data = {
                ...
                series: [
                    ...
                    {
                        name: '지급 금액',
                        data: [<?= gd_implode(',', $memberChart['saveDeposit']); ?>]
                    },
                    {
                        name: '사용 금액',
                        data: [<?= gd_implode(',', $memberChart['useDeposit']); ?>]
                    }
                ]
            },
            options = {
