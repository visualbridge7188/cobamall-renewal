...
<ul class="nav nav-tabs mgb30" role="tablist">
    <li role="presentation" <?= $tabName == 'day' ? 'class="active"' : '' ?>>
        <a href="../statistics/order_area_day.php<?= $queryString ?>">일별 주문현황</a>
    </li>
    <li role="presentation" <?= $tabName == 'hour' ? 'class="active"' : '' ?>>
        <a href="../statistics/order_area_hour.php<?= $queryString ?>">시간대별 주문현황</a>
    </li>
    <li role="presentation" <?= $tabName == 'week' ? 'class="active"' : '' ?>>
        <a href="../statistics/order_area_week.php<?= $queryString ?>">요일별 주문현황</a>
    </li>
    <li role="presentation" <?= $tabName == 'month' ? 'class="active"' : '' ?>>
        <a href="../statistics/order_area_month.php<?= $queryString ?>">월별 주문현황</a>
    </li>
</ul>
    ...
    var grid = new tui.Grid({
        ...
        columnMerge : [
            ...
            ?>
            {
                columnName: "<?= $val; ?>",
                title: "<?= $key; ?>",
                columnNameList: ["goodsPrice<?= $val; ?>", "orderCnt<?= $val; ?>", "memberCnt<?= $val; ?>", "goodsCnt<?= $val; ?>"]
            },
            <?php
            }
            ?>
