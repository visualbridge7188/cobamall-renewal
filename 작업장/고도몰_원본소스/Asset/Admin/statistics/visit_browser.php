...
<form id="frmSearchStatistics" method="get">
    ...
    <ul class="nav nav-tabs mgb20">
        <li><a id="visitInflow" class="hand">운영체제 현황</a></li>
        <li class="active"><a id="visitBrowser" class="hand">웹브라우저 현황</a></li>
    </ul>
    ...
    $(document).ready(function () {
        ...
        var container = document.getElementById('chart-area'),
            data = {
                ...
                series: [
                    <?php
                    foreach ($visitBrowserTitle as $val) {
                    ?>
                    {
                        name: '<?= $val; ?>',
