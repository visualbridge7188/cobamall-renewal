...
<form id="frmSearchStatistics" method="get">
    ...
    <div class="table-dashboard">
        <table class="table table-cols">
            ...
            <tr>
                <td class="bln">
                    <strong><?= number_format($visitTopTotalData['visitTotalCnt']); ?></strong>
                    <ul class="list-unstyled">
                        <li><strong>PC</strong><span><?= number_format($visitTopPcData['visitTotalCnt']); ?></span></li>
                        <li><strong>모바일</strong><span><?= number_format($visitTopMobileData['visitTotalCnt']); ?></span></li>
                    </ul>
                </td>
                <td>
                    <strong><?= number_format($visitTopTotalData['visitCnt']); ?></strong>
                    <ul class="list-unstyled">
                        <li><strong>PC</strong><span><?= number_format($visitTopPcData['visitCnt']); ?></span></li>
                        <li><strong>모바일</strong><span><?= number_format($visitTopMobileData['visitCnt']); ?></span></li>
                    </ul>
                </td>
                <td>
                    <strong><?= number_format($visitTopTotalData['visitNewCnt']); ?></strong>
                    <ul class="list-unstyled">
                        <li><strong>PC</strong><span><?= number_format($visitTopPcData['visitNewCnt']); ?></span></li>
                        <li><strong>모바일</strong><span><?= number_format($visitTopMobileData['visitNewCnt']); ?></span></li>
                    </ul>
                </td>
                <td>
                    <strong><?= number_format($visitTopTotalData['visitReCnt']); ?></strong>
                    <ul class="list-unstyled">
                        <li><strong>PC</strong><span><?= number_format($visitTopPcData['visitReCnt']); ?></span></li>
                        <li><strong>모바일</strong><span><?= number_format($visitTopMobileData['visitReCnt']); ?></span></li>
                    </ul>
                </td>
            </tr>
            </tbody>
