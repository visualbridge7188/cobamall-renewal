...
<form id="frmSearchStatistics" method="get">
    ...
    <div class="table-dashboard">
        <table class="table table-cols">
            ...
            <tr>
                <td>
                    <strong><?= number_format($totalVisit['MaxCount']); ?></strong><br/><span class="font-date"><?= $totalVisit['hour']['MaxCount']; ?>시</span>
                ...
                <td>
                    <strong><?= number_format($totalVisit['MinCount']); ?></strong><br/><span class="font-date"><?= $totalVisit['hour']['MinCount']; ?>시</span>
                    <ul class="list-unstyled">
                ...
                <td>
                    <strong><?= number_format($totalVisit['MaxPV']); ?></strong><br/><span class="font-date"><?= $totalVisit['hour']['MaxPV']; ?>시</span>
                    <ul class="list-unstyled">
                ...
                <td>
                    <strong><?= number_format($totalVisit['MinPV']); ?></strong><br/><span class="font-date"><?= $totalVisit['hour']['MinPV']; ?>시</span>
                    <ul class="list-unstyled">
