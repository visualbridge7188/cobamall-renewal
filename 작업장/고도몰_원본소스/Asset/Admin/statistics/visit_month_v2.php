...
<form id="frmSearchStatistics" method="get">
    ...
    <ul class="nav nav-tabs mgb20">
        ...
        <li class="active"><a id="visitMonth" class="hand">월별 방문현황</a></li>
    ...
    <div class="table-dashboard">
        <table class="table table-cols">
            ...
            <tr>
                <td>
                    <strong><?= number_format($visitTopTotalData['all']['visitMax']); ?></strong><br/><span class="font-date"><?= $visitTopTotalData['all']['visitMaxDate']; ?></span>
                ...
                <td>
                    <strong><?= number_format($visitTopTotalData['all']['visitMin']); ?></strong><br/><span class="font-date"><?= $visitTopTotalData['all']['visitMinDate']; ?></span>
                    <ul class="list-unstyled">
                ...
                <td>
                    <strong><?= number_format($visitTopTotalData['all']['pvMax']); ?></strong><br/><span class="font-date"><?= $visitTopTotalData['all']['pvMaxDate']; ?></span>
                    <ul class="list-unstyled">
                ...
                <td>
                    <strong><?= number_format($visitTopTotalData['all']['pvMin']); ?></strong><br/><span class="font-date"><?= $visitTopTotalData['all']['pvMinDate']; ?></span>
                    <ul class="list-unstyled">
