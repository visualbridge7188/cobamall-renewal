...
<form id="frmSearchStatistics" method="get">
    ...
    <div class="table-dashboard">
        <table class="table table-cols">
            ...
            <tr>
                <td class="bln">
                    <strong><?= number_format($pvTopTotalData['all']['pvTotal']); ?></strong>
                    <ul class="list-unstyled">
                        <li><strong>PC</strong><span><?= number_format($pvTopTotalData['pc']['pvTotal']); ?></span></li>
                        <li><strong>모바일</strong><span><?= number_format($pvTopTotalData['mobile']['pvTotal']); ?></span></li>
                    </ul>
                </td>
                <td>
                    <strong><?= number_format($pvTopTotalData['all']['pvNew']); ?></strong>
                    <ul class="list-unstyled">
                        <li><strong>PC</strong><span><?= number_format($pvTopTotalData['pc']['pvNew']); ?></span></li>
                        <li><strong>모바일</strong><span><?= number_format($pvTopTotalData['mobile']['pvNew']); ?></span></li>
                    </ul>
                </td>
                <td>
                    <strong><?= number_format($pvTopTotalData['all']['pvRe']); ?></strong>
                    <ul class="list-unstyled">
                        <li><strong>PC</strong><span><?= number_format($pvTopTotalData['pc']['pvRe']); ?></span></li>
                        <li><strong>모바일</strong><span><?= number_format($pvTopTotalData['mobile']['pvRe']); ?></span></li>
                    </ul>
                </td>
                <td>
                    <strong><?= number_format($pvTopTotalData['all']['visitTotal']); ?></strong>
                    <ul class="list-unstyled">
                        <li><strong>PC</strong><span><?= number_format($pvTopTotalData['pc']['visitTotal']); ?></span></li>
                        <li><strong>모바일</strong><span><?= number_format($pvTopTotalData['mobile']['visitTotal']); ?></span></li>
                    </ul>
                </td>
                <td>
                    <strong><?= number_format($pvTopTotalData['all']['visitPv']); ?></strong>
                    <ul class="list-unstyled">
                        <li><strong>PC</strong><span><?= number_format($pvTopTotalData['pc']['visitPv']); ?></span></li>
                        <li><strong>모바일</strong><span><?= number_format($pvTopTotalData['mobile']['visitPv']); ?></span></li>
                    </ul>
                </td>
            </tr>
            </tbody>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('.btn-excel').click(function () {
            grid.setDisplayRowCount('<?=$pvCount?>');
        ...
        var container = document.getElementById('chart-area'),
            data = {
                categories: [<?= gd_implode(',', $pvChart['Date']); ?>],
                series: [
                    {
                        name: '페이지뷰',
                        data: [<?= gd_implode(',', $pvChart['pvCnt']); ?>]
                    },
                    {
                        name: '신규방문자PV',
                        data: [<?= gd_implode(',', $pvChart['pvNewCnt']); ?>]
                    },
                    {
                        name: '재방문자PV',
                        data: [<?= gd_implode(',', $pvChart['pvReCnt']); ?>]
                    },
                    {
                        name: '방문자수',
                        data: [<?= gd_implode(',', $pvChart['pvVisitTotal']); ?>]
                    },
                    {
                        name: '방문자당PV',
                        data: [<?= gd_implode(',', $pvChart['pvVisit']); ?>]
                    }
                ]
            },
            options = {
