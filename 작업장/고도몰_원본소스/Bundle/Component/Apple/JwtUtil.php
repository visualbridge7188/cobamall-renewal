 ...
 *
 * @link    https://github.com/web-token/jwt-framework/blob/v1.1/src/Component/Core/Util/ECSignature.php
 */
...
class JwtUtil
{
     ...
     * @return string
     */
    public static function preparePositiveInteger(string $data)
    {
     ...
     * @return string
     */
    public static function retrievePositiveInteger(string $data)
    {
        while ('00' === mb_substr($data, 0, 2, '8bit') && mb_substr($data, 2, 2, '8bit') > '7f') {
            $data = mb_substr($data, 2, null, '8bit');
        }
