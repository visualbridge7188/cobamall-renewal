...
//                                              echo "Str $i = $retstr\n";
                ...
                case SPREADSHEET_EXCEL_READER_TYPE_XF:
                        ...
                        //echo "\nType.XF ".gd_count($this->formatRecords['xfrecords'])." $indexCode ";
                        if (gd_array_key_exists($indexCode, $this->dateFormats)) {
                            //echo "isdate ".$dateFormats[$indexCode];
                            $this->formatRecords['xfrecords'][] = array(
                                    'type' => 'date',
                                    'format' => $this->dateFormats[$indexCode]
                                    );
                        }elseif (gd_array_key_exists($indexCode, $this->numberFormats)) {
