...
class GoodsBatchIconController extends \Controller\Admin\Controller
{
    ...
    public function index()
    {
        ...
        try {
            ...
            // --- 메뉴 설정
            $this->callMenu('goods', 'batch', 'icon');
            ...
            $getData = $goods->getAdminListBatch('icon');
            ...
            $this->setData('icon', $getData['icon']);

            // 공급사와 동일한 페이지 사용
            $this->getView()->setPageName('goods/goods_batch_icon.php');
