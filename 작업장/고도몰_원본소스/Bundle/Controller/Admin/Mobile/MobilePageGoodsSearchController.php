...
class MobilePageGoodsSearchController extends \Controller\Admin\Controller
{
    public function index()
    {

        /**
         * 모바일샵 상품 검색 페이지 설정 페이지
         *
         * [관리자 모드] 모바일샵 상품 검색 페이지 설정 페이지
         * @author    artherot
         * @version   1.0
         * @since     1.0
         * @copyright ⓒ 2016, NHN godo: Corp.
        ...
        //--- 메뉴 설정
        $this->callMenu('mobile', 'page', 'goodsSearch');
        ...
        try {
            ...
            // 페이지 코드
            $pageCode = 'goods_search';

            //--- 모바일샵 상품검색 페이지 설정 config 불러오기
