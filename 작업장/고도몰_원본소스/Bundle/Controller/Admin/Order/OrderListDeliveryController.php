 ...
 */
class OrderListDeliveryController extends \Controller\Admin\Controller
{
    /**
     * @var 기본 주문상태
     */
    ...
    public function index()
    {
        try {
            // --- 메뉴 설정
            $this->callMenu('order', 'order', 'delivery');
            $this->addScript(
                [
            ...
            // 공급사와 동일한 페이지 사용
            $this->getView()->setPageName('order/order_list_delivery.php');
