...
/**
 * 교환 추가 리스트 페이지
 * [관리자 모드] 교환 추가 리스트 페이지
 *
 * @package Bundle\Controller\Admin\Order
 * @author  <bumyul2000@godo.co.kr>
 */
class OrderListExchangeAddController extends \Controller\Admin\Controller
{
    /**
     * @var 기본 주문상태
     */
    private $_currentStatusCode = 'z';
    ...
    public function index()
    {
        try {
            // --- 메뉴 설정
            $this->callMenu('order', 'cancel', 'exchangeAdd');
            $this->addScript(
                [
            ...
            // 공급사와 동일한 페이지 사용
            $this->getView()->setPageName('order/order_list_exchange.php');
