 ...
 * @author  yjwee
 */
class BaseAgreementWithPrivateController extends \Controller\Admin\Controller
{
        ...
        try {
            ...
            switch ($mode) {
                case 'agreement':
                    ...
                    $data = gd_array_merge($fairTrade, ['agreementDate' => $agreementDate]);
                ...
                case 'privateItem':
                    ...
                    $privateMemberRegularTermsConsent = $buyerInform->getInformData(BuyerInformCode::PRIVATE_MEMBER_REGULAR_TERMS_CONSENT, $mallSno);
                    $privateMemberAutoApprovalTermsConsent = $buyerInform->getInformData(BuyerInformCode::PRIVATE_MEMBER_AUTO_APPROVAL_CONSENT, $mallSno);
                    ...
                    $this->setData('privateMemberRegularTermsConsent', $privateMemberRegularTermsConsent['content']);
                    $this->setData('privateMemberAutoApprovalTermsConsent', $privateMemberAutoApprovalTermsConsent['content']);
                    break;
            }
