 ...
 */
class MallDeliveryListController extends \Controller\Admin\Controller
{
    /**
     * {@inheritdoc}
     *
    ...
    {
        // 관리자 메뉴 설정
        $this->callMenu('policy', 'multiMall', 'mallDelivery');

        // 해외배송 콤포넌트 호출
        $overseasDelivery = new OverseasDelivery();

        // 해외배송 기본리스트
        $delivery = $overseasDelivery->getBasicList(\Request::get()->get('page'));
