...
/**
 * Class SslAdminConfigController
 * @package Bundle\Controller\Admin\Policy
 * @author  Seung-gak Kim <surlira@godo.co.kr>
 */
class SslAdminConfigController extends \Controller\Admin\Controller
{
    public function index()
    {
        ...
        // --- 페이지 데이터
        try {
            $getData = $sslAdmin->getAdminSslView();
            if ($getData) {
                $mode = 'modifyAdminSslConfig';
            } else {
                $mode = 'insertAdminSslConfig';
            }
        ...
        // --- 관리자 디자인 템플릿
        $this->callMenu('policy', 'ssl', 'adminConfig');
