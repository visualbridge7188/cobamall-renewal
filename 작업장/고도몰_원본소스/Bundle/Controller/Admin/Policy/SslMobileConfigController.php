...
/**
 * Class SslMobileConfigController
 * @package Bundle\Controller\Admin\Policy
 * @author  Seung-gak Kim <surlira@godo.co.kr>
 */
class SslMobileConfigController extends \Controller\Admin\Controller
{
    public function index()
    {
        ...
        // --- 페이지 데이터
        try {
            $getData = $sslAdmin->getMobileSslView();
            if ($getData) {
                $mode = 'modifyMobileSslConfig';
            } else {
                $mode = 'insertMobileSslConfig';
            }
        ...
        // --- 관리자 디자인 템플릿
        $this->callMenu('policy', 'ssl', 'mobileConfig');
