...
class CouponOfflineManageController extends \Controller\Admin\Controller
{
    ...
    public function index()
    {
        ...
        try {
            ...
            if ($couponNo > 0) {
                $getData = $couponAdmin->getCouponInfo($couponNo, 'couponNo, couponNm, couponDescribed, couponUseType, couponUsePeriodType, couponUsePeriodStartDate, couponUsePeriodEndDate, couponUsePeriodDay, couponUseDateLimit, couponBenefit, couponBenefitType, couponMaxBenefit, couponMaxBenefitType, couponKindType, couponAuthType');
