...
/**
 * [관리자 모드] 통계 > 상품분석 > 관심상품 분석
 * 설명 : 관심상품 분석의 담은 회원 리스트
 *
 * @package Bundle\Controller\Admin\Share
 * @author  su
 */
class LayerGoodsWishMemberController extends \Controller\Admin\Controller
{
    /**
     * {@inheritdoc}
     *
    ...
    {
        try {
            $searchData['searchDate'] = $cartData['wishYMD'] = Request::post()->get('searchDate');
...
//            $cartData['pageNum'] = Request::post()->get('pageNum');
            ...
            $getData = $goodsStatistics->getGoodsWishMemberStatistics($cartData);
