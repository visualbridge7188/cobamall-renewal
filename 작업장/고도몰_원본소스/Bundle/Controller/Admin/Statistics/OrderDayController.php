 ...
 * @author  su
 */
class OrderDayController extends \Controller\Admin\Controller
{
    public function index()
    {
        try {
            ...
            $getDataArr = $orderSalesStatistics->getOrderDay($order);
            ...
            foreach ($getDataArr as $key => $val) {
                ...
                foreach ($val as $deviceKey => $deviceVal) {
                    ...
                    $returnOrderStatistics[$i]['goodsPrice' . ucfirst($deviceKey)] = NumberUtils::moneyFormat($deviceVal['goodsPrice']);
