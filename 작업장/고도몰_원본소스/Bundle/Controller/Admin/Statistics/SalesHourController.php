 ...
 * @author  su
 */
class SalesHourController extends \Controller\Admin\Controller
{
    public function index()
    {
        try {
            ...
            $getDataArr = $orderSalesStatistics->getOrderSalesHour($order);
