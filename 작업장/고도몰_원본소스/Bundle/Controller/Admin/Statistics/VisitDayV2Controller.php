...
class VisitDayV2Controller extends \Controller\Admin\Controller
{
    ...
    public function index()
    {
        ...
        try {
            ...
            /* chart */
            $visitDate = gd_array_keys($downDataArr);
            $visitCnt = gd_array_column($downDataArr, 'visitCnt');
            $visitNumberCnt = gd_array_column($downDataArr, 'visitTotal');
            $visitNewCnt = gd_array_column($downDataArr, 'visitNew');
            $visitReCnt = gd_array_column($downDataArr, 'visitRe');
            ...
            if (gd_count($visitChart['Date']) < 2) {
                ...
                $visitChart['NewCount'] = gd_array_merge($emptyArr, $visitChart['NewCnt']);
                $visitChart['ReCount'] = gd_array_merge($emptyArr, $visitChart['ReCnt']);
            }
