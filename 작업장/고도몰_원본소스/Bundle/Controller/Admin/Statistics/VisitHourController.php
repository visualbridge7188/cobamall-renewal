 ...
 */
class VisitHourController extends \Controller\Admin\Controller
{
    /**
     * index
     *
    ...
    public function index()
    {
        ...
        try {
            ...
            if ($searchMall == 'all') {
                $getDataArr = $visitStatistics->getVisitHourAllMall($searchDate);
            } else {
                $getDataArr = $visitStatistics->getVisitHour($searchDate, $searchMall);
            }
            ksort($getDataArr);
            ...
            foreach ($getDataArr as $key => $val) {
                if ($i == 0) {
                    ...
                    $totalVisit['hour']['MaxCount'] = $key . ':00';
