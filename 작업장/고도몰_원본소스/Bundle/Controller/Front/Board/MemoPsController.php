...
class MemoPsController extends \Controller\Front\Controller
{
        ...
        switch ($req['mode']) {
            ...
            case 'getMemo' : {
                try {
                    ...
                    echo $this->json(['result'=>'ok','writerNm'=>$data['writerNm'],'memo'=>gd_htmlspecialchars_stripslashes($data['memo'])]);
                } catch (\Exception $e){
                    echo $this->json(['result' => 'fail', 'msg' => $e->getMessage()]);
                }
                exit;
