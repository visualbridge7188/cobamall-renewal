...
class PlusReviewMypageController extends \Controller\Front\Controller
{
    public function index()
    {
        ...
        $targetNo = $plusReviewConfig['authWriteExtra'] === 'all' ? $data['buyGoodsData']['goodsNo'] : $data['buyGoodsData']['sno'];
        $plusReviewConfig['mileageAddGoodsPriceFl'] = $plusReviewArticle->getGivingGoodsMileageData($targetNo)['result'] === true ? 'y' : 'n';
