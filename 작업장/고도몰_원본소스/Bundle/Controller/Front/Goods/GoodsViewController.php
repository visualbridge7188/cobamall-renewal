...
class GoodsViewController extends \Controller\Front\Controller
{
    ...
    public function index()
    {
        ...
        if (gd_in_array('goodsDiscount', $displayField['goodsDisplayField']['pc']) === true && empty($goodsView['goodsPriceString']) === true) {
            if (empty($displayField['goodsDiscount']['pc']) === false) {
                if (gd_in_array('goods', $displayField['goodsDiscount']['pc']) === true) $goodsView['dcPrice'] += $goodsView['goodsDcPrice'];
                if (gd_in_array('coupon', $displayField['goodsDiscount']['pc']) === true) $goodsView['dcPrice'] += $goodsView['couponDcPrice'];
            }
        }
        ...
        if (gd_in_array('dcRate', $displayField['goodsDisplayAddField']['pc']) === true) {
        ...
        if ($goodsView['commonContent']) {
            $tag = "title";
            gd_preg_match_all( '@'.$tag.'="([^"]+)"@' , $goodsView['commonContent'], $match );
        ...
        $fixedPriceTag = '';
        $fixedPriceTag2 = '';
        if ((gd_in_array('couponPrice', $displayField['goodsDisplayField']['pc']) && $goodsView['couponPrice'] > 0) && $couponConfig['couponUseType'] == 'y' && ($goodsView['timeSaleInfo']['couponFl'] == 'n' || !$goodsView['timeSaleInfo']) || (gd_in_array('goodsDiscount', $displayField['goodsDisplayField']['pc']) && $goodsView['dcPrice'] > 0 && !$goodsView['timeSaleInfo'])) {
            $goodsPriceTag = '<b>';
            $goodsPriceTag2 = '</b>';
        } else {
