    ...
    public function index()
    {
        try {
            ...
            if ($useRegularOrder) {
                ...
                $this->setData('regularShoppingUrl', $regularOrderCart->shoppingUrl); // 쇼핑 계속하기 URL
                ...
                $this->setData('regularGoodsPriceOptionText', $regularGoodsPriceInfo['regularGoodsPriceOptionTextList']); // 주문 상품 별 텍스트옵션 가격
                $this->setData('regularGoodsPriceOptionTextTotal', $regularGoodsPriceInfo['regularGoodsPriceOptionTextTotalList']); // 주문 상품 별 텍스트옵션 총 가격
                $this->setData('regularTotalPriceList', $regularGoodsPriceInfo['regularTotalPriceList']); // 주문 상품별 총 가격
                $this->setData('regularTotalPrice', $regularGoodsPriceInfo['regularTotalPrice']); // 전체 주문 상품의 총 가격
            ...
            throw new AlertOnlyException(__('오류') . ' - ' . __('오류가 발생 하였습니다.'), null, null, '../order/cart.php', 'parent');
        }
    }
