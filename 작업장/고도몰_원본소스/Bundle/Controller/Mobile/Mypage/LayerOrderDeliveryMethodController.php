 ...
 */
class LayerOrderDeliveryMethodController extends \Controller\Mobile\Controller
{
    /**
     * {@inheritdoc}
     */
    public function index()
    {
        try {
            ...
            // 주문 상품 정보
            $orderGoodsData = $order->getOrderGoodsData(Request::get()->get('orderNo'), Request::get()->get('orderGoodsNo'), null, null, 'user', false);
